...
namespace RasHack.GapOverlap.Main.Result
{
    ...
    public class TestResults
    {
        ...
        public void AttachMeasurement(TaskType taskType, StimuliType stimuliType, StimulusSide side, int taskOrder,
        ...
        private string Header()
        {
            ...
            header.Append(",").Append(Quote("task_order"));
        ...
        private static int ResultsCsv(TestRun results, IList<string> destination, int index)
        {
            for (var i = 0; i < results.Measurements.Count; i++)
            {
                ...
                csv.Append(",").Append(Quote(measurement.TaskOrder.ToString()));
